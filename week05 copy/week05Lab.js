...
console.log(`"On July 20th ${person.year}, ${person.firsname} ${person.lastname} was the first person to set foot on the Earth's moon."`)
/*-------------------------------------------------------*/
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting('cynthia','Las Vegas')
myGreeting.hello()
/*-------------------------------------------------------*/
// Question 3: myBook
console.log(`--------------------------
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myBook = new Book ('Pride and Predjudice', `Jane Austen`)
console.log(myBook.title);
console.log(myBook.author);

console.log (myBook.describe())

let yourBook = new Book (`The Shack`,  `William P. Young`)
 ...
 * ↓ YOUR CODE HERE ↓ */
class Fruit {
  constructor (name1, color, taste) {
    this.name1 = name1;
    this.color = color;
    this.taste = taste;
  } 
  describe () {
    return `A ${this.name1} is ${this.color} and has a ${this.taste} taste.`;
  }
...
let child2 = new Child ( `Wednesday`, 16);
child.details();
child2.details();
