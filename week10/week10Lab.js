...
mySubmitButton = document.createdElement('button')
...
//Answer: class, properties, styles
...
myTdName.innterHTML = 'Name'
myTdEmail.innterHTML = 'Email'
...
//Answer: it takes less steps and lessens the amount of changes you might have to make
...
//Answer: mousedown, mouseover, scroll
