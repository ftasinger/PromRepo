...
let friend1 = "Cynthia"
let friend2 = "Stephanie"

console.log(food, drink, friend1, friend2);

//Question: Name a reason why you would use const instead of let.
//Answer: If you want to prevent the variable from being changed and its output to remain as what your originally put in then you would use a const.
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`for lunch ${friend2} & ${friend1} ate ${food} and drank ${drink}`)
...
//Answer: 
console.log("For Lunch " + friend1 + " and " + friend2 + " ate " + food + "and " + "drank " + drink);
...
//Answer: we tried to reassigna variable that is a constant. It will not dd it but rather shows an error.
...
const lunchTime = (foodChoice, drinkChoice) => { 
   return `For lunch ${friend2} & ${friend1} ate  ${foodChoice} and drank ${drinkChoice}`
};
...
console.log(foodForTodayAndTomorrow('Pizza', 'Water', lunchTime('newFoodItem', 'newDrinkItem')));
